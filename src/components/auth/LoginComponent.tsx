...
function LoginComponent() {
    ...
    const API_BASE_URL ="http://localhost:5173/oauth2/redirect"
    const OAUTH2_REDIRECT_URI ="http://localhost:8080"
const  url ="http://localhost:8080/oauth2/authorize/google?redirect_uri=http://localhost:5173/oauth2/redirect"
                ...
                <Modal>
                    <div ref={loginRef} className="text-xl space-y-5 bg-white p-6 rounded-lg shadow-lg">
                        ...
                        <div className="flex flex-col space-y-2">
                            ...
                            <p className="mt-5">
                                We'll send a magic login link to your email
                            </p>
                            <a href={GOOGLE_AUTH_URL}>
                                <button className="p-2 bg-red-500 text-white  flex items-center">
